...
- **Tính toán định lượng** do logic Node.js/JavaScript trên AWS Lambda xử lý để đảm bảo các chỉ số như RSI, MACD, moving average được tính nhất quán.
...
- Lambda Processing tính toán chỉ báo kỹ thuật bằng logic Node.js/JavaScript.
...
Processing Lambda dùng Node.js 22.x và các hàm JavaScript để tính toán chỉ báo kỹ thuật như RSI, MACD và moving average. Việc tính toán bằng code giúp đảm bảo kết quả định lượng không phụ thuộc vào suy luận của AI.
